  ...
  return (
    <Table borderStyle={{borderWidth: 1}}>
      <TableWrapper style={tableStyles.row}>
        <Cell
          data={intl.formatMessage(messages['gpus.name.header'])}
          style={tableStyles.mainHeader}
          textStyle={tableStyles.mainHeaderText}
        />
        <Cell
          data={intl.formatMessage(messages['gpus.gpu_usage.header'])}
          style={tableStyles.header}
          textStyle={tableStyles.headerText}
        />
        <Cell
          data={intl.formatMessage(messages['gpus.memory.header'])}
          style={tableStyles.header}
          textStyle={tableStyles.headerText}
        />
      </TableWrapper>
