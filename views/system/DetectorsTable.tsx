  ...
  return (
    <Table borderStyle={{borderWidth: 1}}>
      <TableWrapper style={tableStyles.row}>
        <Cell data={intl.formatMessage(messages['detectors.detector.header'])} style={tableStyles.mainHeader} textStyle={tableStyles.mainHeaderText} />
        <Cell data={intl.formatMessage(messages['detectors.inference_speed.header'])} style={tableStyles.header} textStyle={tableStyles.headerText} />
        {isCpuUsageInfo ? <Cell data={intl.formatMessage(messages['detectors.cpu_usage.header'])} style={tableStyles.header} textStyle={tableStyles.headerText} /> : <></>}
        {isCpuUsageInfo ? <Cell data={intl.formatMessage(messages['detectors.mem_usage.header'])} style={tableStyles.header} textStyle={tableStyles.headerText} /> : <></>}
      </TableWrapper>
      <TableWrapper style={tableStyles.row}>
        <Col data={dataHeaders} style={tableStyles.dataHeader} textStyle={tableStyles.dataHeaderText} />
        <Col data={inferenceSpeedData} style={tableStyles.data} textStyle={tableStyles.dataText} />
