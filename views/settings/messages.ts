...
export const messages = makeMessages('settings', {
  ...
  'appearence.header': 'Appearence',
  'appearence.theme.label': 'Theme',
  'appearence.theme.option.auto': 'Auto',
  'appearence.theme.option.light': 'Light',
  'appearence.theme.option.dark': 'Dark',
  'action.save': 'Save',
